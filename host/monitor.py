...
def command_to_packet(raw: str) -> dict[str, str] | None:
    ...
    print(
        "Commands: ping | servo_test | beep info | beep warning | beep critical | quit",
        file=sys.stderr,
    )
    return None
...
def run(args: argparse.Namespace) -> int:
    ...
    with serial.Serial(port, args.baud, timeout=0.2) as ser, open_log(args.log) as log_file:
        ...
        print("Commands: ping | servo_test | beep info | beep warning | beep critical | quit")
